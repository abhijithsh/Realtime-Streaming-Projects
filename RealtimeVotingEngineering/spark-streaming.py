...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars",
                     "/home/abhijith/PycharmProjects/RealtimeVotingEngineering/postgresql-42.7.1.jar")
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/home/abhijith/PycharmProjects/RealtimeVotingEngineering/checkpoint/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/home/abhijith/PycharmProjects/RealtimeVotingEngineering/checkpoint/checkpoint2") \
        .outputMode("update") \
        .start()
